...
// console.log("nav",navbarWidth,isMobile)
  ...
  return (
    <div ref={isiRef}   style={!isMobile ? { width: `${navbarWidth.width}px` } : {}}   id="isi" className=" w-[80%]  mt-4 xl:mt-6 list-disc marker:text-list_color text-[18px] xl:text-[18px] xxl:text-[18px] font-[300] tracking-[0.09px]   leading-[20px]">
    <div className="bg-white mt-0 pt-0 ">
      <p className=" text-[22px] xl:text-[22px] xxl:text-xl font-[700] mb-3  text-dark_green">IMPORTANT SAFETY INFORMATION AND INDICATION</p>
      <p className="font-[400] xl:mb-2 mb-1 ">
      ...
      <p className="font-[400] xl:mb-2 mb-0 ">
        Before taking ORSERDU, tell your healthcare provider about all your
        medical conditions, including if you:
      </p>
      <ul className="list-disc ml-5  mb-4 flex flex-col  mt-2 xl:mt-0 gap-2">
        ...
        <ul className=" list-disc  ml-3 flex flex-col gap-2 [&>li]:list-[circle]">
          <p className="font-[400] xl:mb-2 mb-0  mt-2 m">
          ...
          <p className="font-[400] xl:mb-2 mb-0  mt-2">
      ...
      <ul className="list-disc  leading-[18px] xl:leading-[16px] grid grid-cols-1 mt-2 xl:mt-0 ml-5 gap-2 xl:gap-[10px] xl:mb-4">
        <li className=''>Muscle and joint (musculoskeletal) pain</li>
        <li>Nausea
      ...
      <ul className="list-disc leading-[18px] xl:leading-[16px]  grid grid-cols-1 mt-2 xl:mt-0 ml-5 gap-2 xl:gap-[10px] mb-4">
      ...
      <p className="mb-4">
                    ...
                    doctor for medical advice about side effects. You may report side effects to the FDA at <span className='text-nowrap'>1-800-FDA-1088</span> or visit {""}
      ...
      <p className="mb-4">
        ...
        (HER2)-negative, <span className='font-[300]'>ESR1</span>-mutated advanced breast cancer or breast
