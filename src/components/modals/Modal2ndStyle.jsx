...
const Modal2ndStyle = ({ 
  ...
  onClose, 
  onContinue, 
  title = "You are about to go to a site intended for US healthcare professionals.", 
  description = "Are you a US healthcare professional?",
  continueText = "Yes, I am a US healthcare professional",
  cancelText = "No, I am not a US healthcare professional"
}) => {
  useEffect(() => {
